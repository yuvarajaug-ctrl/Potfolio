document.addEventListener('DOMContentLoaded', () => {
    ...
    const projectData = {
        ...
        project5: { title: 'Expense Tracker App', desc: 'College Python project that manages daily expenses with add/edit/delete functionalities, and generates monthly reports.', source: 'https://github.com/yuvarajaug-ctrl/Expense-Tracker-App', live: 'https://yuvarajaug-ctrl.github.io/Expense-Tracker-App/' }
    };
